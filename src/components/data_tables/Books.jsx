            ...
            <div className="card" style={{ background: '#9bc1de', maxWidth: '1200px' }}>
                {
                    ...
                    <Toolbar className="mb-4 toolbar-datatable" left={leftToolbarTemplate(openNew, onlyDisabled, toggleDisabled, icon)} right={rightToolbarTemplateExport(handleExportCsv, handleExportExcel, handleExportPdf)}></Toolbar>
                }
                <CustomDataTable
                    dt={dt}
                    data={books}
